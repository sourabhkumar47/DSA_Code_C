...
// // find distinct - from a list of duplicate print element that exists one time
// int findDistinct(vector<int> arr) {
//   int ans = 0;
//   for (int i = 0; i < arr.size(); i++) {
//     // xor will cancel same number ans only left is uniqure
//     ans = ans ^ arr[i];
//   }
//   return ans;
// }
...
//   while (start <= end) {
//     if (arr[i] == 0) {
//       //we donot need this also just increase start++
